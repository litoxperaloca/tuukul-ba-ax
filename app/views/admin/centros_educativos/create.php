<?php
// app/views/admin/centros_educativos/create.php
...
<div class="container mx-auto py-10 px-6">
    <div class="flex items-center mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-800">Crear Nuevo Centro Educativo</h1>
    </div>

    <div class="bg-white p-8 rounded-lg card-shadow max-w-xl mx-auto">
        <form action="/admin/centros-educativos/process-create" method="POST" class="space-y-6">
            <div>
            ...
            <div class="mt-4">
                ...
                <input type="text" name="nombre" id="nombre" required class="input-style" placeholder="Ej: Escuela Primaria 'Benito Juárez'">
            </div>
            <div class="mt-4">
                <label for="cct" class="label-style">CCT (Clave de Centro de Trabajo) - Opcional</label>
                <input type="text" name="cct" id="cct" class="input-style" placeholder="Ej: 09DPR0001A">
            </div>
            <div class="mt-4">
                <label for="direccion" class="label-style">Dirección - Opcional</label>
                <textarea name="direccion" id="direccion" rows="2" class="input-style" placeholder="Ej: Calle Falsa 123, Colonia Centro"></textarea>
            </div>
