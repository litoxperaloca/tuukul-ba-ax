<?php
// app/views/admin/paises/create.php
...
<div class="container mx-auto py-10 px-6">
    <div class="flex items-center mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-800">Crear Nuevo País</h1>
    </div>

    <div class="bg-white p-8 rounded-lg card-shadow max-w-xl mx-auto">
        <form action="/admin/paises/process-create" method="POST" class="space-y-6">
            <div>
                <label for="nombre" class="label-style">Nombre del País</label>
                <input type="text" name="nombre" id="nombre" required class="input-style" placeholder="Ej: México">
            </div>
            <div>
                <label for="codigo_iso" class="label-style">Código ISO (2 letras)</label>
                <input type="text" name="codigo_iso" id="codigo_iso" maxlength="2" required class="input-style uppercase" placeholder="Ej: MX">
            </div>
