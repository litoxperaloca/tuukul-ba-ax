<?php
// app/views/admin/formularios_dinamicos/create.php (Con Constructor de Formularios)
...
<div class="container mx-auto py-10 px-6">
    <div class="flex items-center mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-800">Crear Nuevo Formulario Dinámico</h1>
    </div>

    <div class="bg-white p-8 rounded-lg card-shadow max-w-5xl mx-auto">
        <form id="dynamic-form-builder-form" action="/admin/formularios-dinamicos/process-create" method="POST" class="space-y-6">
            <fieldset class="border p-4 rounded-md">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="nombre" id="nombre" required class="input-style" placeholder="Ej: Formulario Planeación EF Primaria 3°">
                </div>
            </fieldset>
