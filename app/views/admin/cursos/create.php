<?php
// app/views/admin/cursos/create.php
...
<div class="container mx-auto py-10 px-6">
    <div class="flex items-center mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-800">Crear Nuevo Curso</h1>
    </div>

    <div class="bg-white p-8 rounded-lg card-shadow max-w-3xl mx-auto">
        <form action="/admin/cursos/process-create" method="POST" class="space-y-6">
            <fieldset class="border p-4 rounded-md">
                ...
                <div>
                    ...
                    <select name="id_plan_estudio" id="id_plan_estudio" required class="input-style">
                        <option value="" disabled selected>Selecciona un plan de estudio</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    <div>
                        ...
                        <input type="text" name="nivel" id="nivel" required class="input-style" placeholder="Ej: Primaria">
                    </div>
                    <div>
                        <label for="grado" class="label-style">Grado</label>
                        <input type="text" name="grado" id="grado" required class="input-style" placeholder="Ej: 3°">
                    </div>
                    <div>
                        <label for="asignatura" class="label-style">Asignatura</label>
                        <input type="text" name="asignatura" id="asignatura" required class="input-style" placeholder="Ej: Educación Física">
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        <label for="fase" class="label-style">Fase (Opcional)</label>
                        <input type="text" name="fase" id="fase" class="input-style" placeholder="Ej: Fase 4">
                    </div>
                    <div>
                        <label for="descripcion" class="label-style">Descripción (Opcional)</label>
                        <textarea name="descripcion" id="descripcion" rows="2" class="input-style" placeholder="Breve descripción del curso"></textarea>
                    </div>
                </div>
                    ...
                    <?php else: ?>
                        <?php foreach ($centros_educativos as $centro): ?>
                            <div class="flex items-center">
                                <input type="checkbox" name="centros_educativos[]" value="<?= htmlspecialchars($centro['id']) ?>" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-200">
