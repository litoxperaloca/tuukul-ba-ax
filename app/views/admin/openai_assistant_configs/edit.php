<?php
// app/views/admin/openai_assistant_configs/edit.php
...
<div class="container mx-auto py-10 px-6">
    <div class="flex items-center mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-800">Editar Configuración de Asistente IA: <?= htmlspecialchars($config['assistant_id']) ?></h1>
    </div>

    <div class="bg-white p-8 rounded-lg card-shadow max-w-3xl mx-auto">
        <form action="/admin/asistentes-ia/process-update/<?= htmlspecialchars($config['id']) ?>" method="POST" class="space-y-6">
            <div>
                ...
                <select name="id_curso" id="id_curso" required class="input-style">
                    ...
                    <?php foreach ($cursos as $curso): ?>
                        <option value="<?= htmlspecialchars($curso['id']) ?>" <?= ($curso['id'] == $config['id_curso']) ? 'selected' : '' ?>>
            ...
            <div class="mt-4">
                ...
                <input type="text" name="assistant_id" id="assistant_id" value="<?= htmlspecialchars($config['assistant_id']) ?>" required class="input-style font-mono" placeholder="Ej: asst_abc123DEF456">
            ...
            <div class="mt-4">
                ...
                <input type="text" name="vector_store_id" id="vector_store_id" value="<?= htmlspecialchars($config['vector_store_id'] ?? '') ?>" class="input-style font-mono" placeholder="Ej: vs_xyz789GHI012">
            ...
            <div class="mt-4">
                ...
                <textarea name="instrucciones_adicionales" id="instrucciones_adicionales" rows="5" class="input-style" placeholder="Ej: Asegúrate de siempre mencionar la importancia del calentamiento."><?= htmlspecialchars($config['instrucciones_adicionales'] ?? '') ?></textarea>
